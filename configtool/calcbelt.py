...
class CalcBelt(wx.Dialog):
	def __init__(self, parent, cbUse):
		wx.Dialog.__init__(self, parent, wx.ID_ANY, "Steps Calculator for Belt Driven Axes", size=(360, 300))
		...
		lsz = wx.BoxSizer(wx.HORIZONTAL)
		st = wx.StaticText(self, wx.ID_ANY, "Belt Pitch (in mm):", size=(labelWidth, -1), style=wx.ALIGN_RIGHT)
		lsz.Add(st)
		lsz.AddSpacer((5,5))
		...
		lsz.Add(tc)
		tc.SetToolTipString("Belt Pitch")
		self.tcBeltPitch = tc
		
		lsz.AddSpacer((5,5))

		beltPresets = [ "-", "2mm Pitch (GT2)", "MXL Pitch (2.03mm)", "T2.5 (2.5mm)", "3mm Pitch (GT2,HTD)", "5mm Pitch (T5,GTD,HTD)", "0.2\" XL belt (5.08mm)" ]
		...
		lsz.Add(tc)
		tc.SetToolTipString("Belt Presets")
		self.tcPresets = tc
		...
		lsz = wx.BoxSizer(wx.HORIZONTAL)
		st = wx.StaticText(self, wx.ID_ANY, "Pulley Teeth Count:", size=(labelWidth, -1), style=wx.ALIGN_RIGHT)
		lsz.Add(st)
		lsz.AddSpacer((5,5))
		...
		tc.Bind(wx.EVT_TEXT, self.onTextCtrlFloat)
		lsz.Add(tc)
		tc.SetToolTipString("Pulley Teeth Count")
		...
		tc = wx.StaticText(self, wx.ID_ANY, "", size=(200,-1), style=wx.ALIGN_LEFT)
		lsz.Add(tc)
		self.tcResult = tc
	...
	def calculate(self):
		...
		self.tcResolution.SetLabel("%.3f microns" % (length/steps*1000.0))
