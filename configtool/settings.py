...
class SettingsDlg(wx.Dialog):
	def __init__(self, parent, settings):
		...
		self.fields = [["Arduino Directory", settings.arduinodir, None], ["C Compiler Flags", settings.cflags, None], 
				["LD flags", settings.ldflags, None], ["Object Copy Flags", settings.objcopyflags, None],
				["AVR Programmer", settings.programmer, None], ["Port", settings.port, None]]
		...
		for f in self.fields:
			...
			t = wx.StaticText(self, wx.ID_ANY, f[0], size=(labelWidth, -1), style=wx.ALIGN_RIGHT)
