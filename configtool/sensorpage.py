...
class SensorsPage(wx.Panel, Page):
	def __init__(self, parent, nb, idPg):
		...
		self.labels = { 'TEMP_MAX6675': " MAX6675", 'TEMP_THERMISTOR': "Thermistor", 'TEMP_AD595': 'AD595',
		...
		self.bDelete.SetToolTipString('Remove the selected temperature sensor from the configuration')
